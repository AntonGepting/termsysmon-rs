...
pub const ICON_SD: &str = "";
pub const ICON_SR: &str = "󰗮";
pub const ICON_LOOP: &str = "";
pub const ICON_DM: &str = "";

pub const ICON_WIFI: &str = "";
pub const ICON_BR: &str = "";
pub const ICON_ETH: &str = "󰈀";
pub const ICON_VETH: &str = "󰈀";
